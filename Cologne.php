...
<body class="location-body">
    ...
    <section class="location-section">
        ...
        <div class="location-detail" id="cologne">
            <h1>Cologne</h1>

            <p>This waterfront complex is one of the finest works of modern architecture in the city. It is also quite
                popular among places to go in Cologne for hanging out, dining, cafes, leisure activities and so on. The
                complex also has a few galleries and event venues. You would need about an hour to explore this place.
            </p>
